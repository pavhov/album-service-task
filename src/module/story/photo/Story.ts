...
export class PhotoStory {
	 ...
	 * @param data
	 */
    public get(data: Photo.Request.PhotoPagination): Promise<Photo.Response.Photo[]> {
	 ...
	 * @param data
	 */
    public delete(data: Photo.Request.DeletePhoto): Promise<DeleteResult> {
	 ...
	 * @param data
	 */
    public updateAlbum(data: Photo.Request.UpdateAlbum): Promise<UpdateResult> {
